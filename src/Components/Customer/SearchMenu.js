...
const SearchMenu = () => {
    ...
    return (
        <div className='container animate__animated animate__fadeIn'>
            <form className="form-inline d-flex mt-3 justify-content-center" onSubmit={handleSubmit} >
                <input className="form-control search mx-3" type="search" placeholder="Search Food" value={query} onChange={handleInputChange} />
