        ...
        <div className="row">
          ...
          >
            <h3 className="fs-3 flex-fill col-prim">
              <span className="text-warning fw-bold fs-2">आजचा</span> <span className="text-light">Menu</span>
            </h3>
            ...
            <ul className="navbar-nav">
              <li
                className={`nav-item py-3 ${
                  section === 1 ? `text-warning fw-bolder` : ``
                }`}
                onClick={() => handleTabClick(1)}
              >
                <a className="nav-link">
                  <CgProfile className="mx-3 cursor-pointer" />
                  Update Profile
                </a>
              </li>
              ...
              <li
                className={`nav-item py-3 ${
                  section === 2 ? `text-warning fw-bolder` : ``
                }`}
                onClick={() => handleTabClick(2)}
              >
                <a className="nav-link">
                  <MdSystemUpdateAlt className="mx-3 cursor-pointer" /> Update
                  Menu
                </a>
              </li>
              ...
              <li className="nav-item py-3 " onClick={logout}>
                <a className="nav-link">
                  <BiLogOut className="mx-3 cursor-pointer" /> Log Out
                </a>
              </li>
            </ul>
          </div>
